...
export class WebApiService implements InMemoryDbService {
      ...
      const users = [
        {
          ...
          name: 'Milka Milic',
          username: 'Milki',
          email: 'milka.milkic@milki.com'
        },
        {
          id: 2,
          name: 'Pero Peric',
          username: 'Peki',
          email: 'pero.peric@peki.com'
        },
        {
          id: 3,
          name: 'Stefan Stefanovic',
          username: 'Stefo',
          email: 'stefan.stefanovic@stivo.coom'
        },
        {
          id: 4,
          name: 'Rumenka Rumenkovic',
          username: 'Rumena',
          email: 'rumenka.rum@rumi.coom'
        },
        {
          id: 5,
          name: 'Radenko Radenkovic',
          username: 'Radan',
          email: 'radan.rad@radmail.coom'
        },
    ];
  ...
  genId(events: any[], users:any[]): number {
